...
from pytest import *
import lexlib.clusters as clusters
...
class TestClusters:
    ...
    def test_handles_words_with_onset_and_offset(self):
        ...
        result = clusters.clusters(words, ["A", "c", "I", "i"])
    ...
    def test_handles_sequential_vwls(self):
    ...
    def test_positional_handles_monosyllabics_with_onset_and_coda(self):
        words = ["kAt", "dcg", "dIg", "kAts", "skAt"]
        initial, medial, final = clusters.positional_clusters(words, ["A", "c",
                                                                      "I", "i"])
    ...
    def test_positional_handles_sequential_vwls(self):
        # No, these aren't actually words
        words = ["AiG", "blftiIi", "bAGliclt"]
        initial, medial, final = clusters.positional_clusters(words, ["A", "c",
                                                                      "I", "i"])
